////Worker – это будет наш главный обработчик.
//using System;
...
//        /// </summary>
//        private const String TemplateFolder = "~/CreateExcel/Templates";

//        /// <summary>
//        /// имя листа шаблона (с которым мы будем работать) 
//        /// </summary>
//        private const String SheetName = "list1";
...
//            get
//            {
//                const string excelFilesPath = @"~/CreateExcel/Files";
